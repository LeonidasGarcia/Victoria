...
class Body(Frame):
    ...
    def create_simulate_screen(self, victoria_units: List[Victoria], program_count: int, reference_trace: List[ReferenceTraceModel]):
        self.current_screen.grid_remove()
        ...
        self.simulate_screen = SimulateScreen(self, victoria_units, program_count=program_count, reference_trace=reference_trace)
